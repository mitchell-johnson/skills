...
# List DO instances (REST API list-objects endpoint)
curl "https://api.cloudflare.com/client/v4/accounts/$ACCOUNT_ID/workers/durable_objects/namespaces/$NAMESPACE_ID/objects" \
  -H "Authorization: Bearer $CLOUDFLARE_API_TOKEN"
```

For SQLite-backed DOs, you can also browse instances and their storage with Data Studio in the Cloudflare dashboard.
