...
R2 integrates with Cloudflare Queues for reactive workflows. Configure via the dashboard or Wrangler (not wrangler.jsonc):

```bash
npx wrangler r2 bucket notification create <BUCKET> --event-type <EVENT_TYPE> --queue <QUEUE>
# Optionally filter by key: --prefix <PREFIX> --suffix <SUFFIX>
```
