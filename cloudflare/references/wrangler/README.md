...
wrangler pages deploy <dir>       # `wrangler pages deployment` has only `list` and `tail`
# Newer command groups also exist: `wrangler flagship`, `wrangler artifacts`, `wrangler vpc`
```
